...
namespace OnlyanKreditSistemi.Migrations
{
    ...
    [Migration("20241003142126_addedLoanDetail")]
    partial class addedLoanDetail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlyanKreditSistemi.Models.BranchProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OnlyanKreditSistemi.Models.LoanItem", b =>
                {
                    b.HasOne("OnlyanKreditSistemi.Models.BranchProduct", null)
                        .WithMany("LoanItems")
                        .HasForeignKey("BranchProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlyanKreditSistemi.Models.Loan", null)
                        .WithMany("LoanItems")
